...
```bash
pipx install --force "plugin-scanner==3.0.40"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `3c7ac7bf712e589203ed86c8ac030f64896937a0038cc0b038d2cb68cd1b3970`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.40"

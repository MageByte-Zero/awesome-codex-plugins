...
```bash
pipx install --force "plugin-scanner==3.0.28"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `f2a9113ee27e1afd0e72aeb4852dd3b8e80129217d70a5b41b2ff1303f4861c4`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.28"

...
```bash
pipx install --force "plugin-scanner==3.0.4"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `b65071fb00a6286e0345aeb150d701c823b6f57a9e385d375e624324bdf1f40b`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.4"

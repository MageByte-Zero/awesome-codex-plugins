...
```bash
pipx install --force "plugin-scanner==3.0.5"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `d691bf809736657dcbb107e94514de3c234a664743b2d933acb27f93ef7e076f`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.5"

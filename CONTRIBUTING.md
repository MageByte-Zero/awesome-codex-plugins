...
```bash
pipx install --force "plugin-scanner==3.0.39"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `82a7539323ae8c2a0f77c8c95630cd751c6aa062c7ce8bae8a9de75d8a98d136`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.39"

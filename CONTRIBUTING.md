...
```bash
pipx install --force "plugin-scanner==3.0.7"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `2901f3e9ba08ad4f274b9f1ff1b63eb2cf8fec9fa8009aeb7fbf51b002ee9f81`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.7"

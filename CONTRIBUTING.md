...
```bash
pipx install --force "plugin-scanner==3.0.27"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `4798df430215ffeabd7d93a725b4dbd1997a98e05f8de3f7482efdd6ed774b96`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.27"

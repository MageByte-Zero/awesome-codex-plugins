...
```bash
pipx install --force "plugin-scanner==3.0.37"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `7c2c73aeb483c0c7de9a07dce25179f725d6923a3b1e6bc58ca0a394f1b07b46`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.37"

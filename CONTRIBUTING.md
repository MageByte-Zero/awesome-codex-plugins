...
```bash
pipx install --force "plugin-scanner==3.0.30"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `6c43835849b344b609640dc824909056272f8e6fcaf977a07137f6b340b97386`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.0.30"

...
- [spec-superflow](https://github.com/MageByte-Zero/spec-superflow) - Lean spec workflow with direct or planned execution, optional specifications, one final review by default, recoverable state, a bundled same-version CLI runtime, and Windows-compatible WorkBuddy installation.
